    ...
    inner class ScopeToggleTests {
        ...
        fun `setScope should not affect other state fields`() = runTest {
            ...
            viewModel.uiState.test {
                ...
                assertEquals(beforeScope.cookingStreak, afterScope.cookingStreak)
                assertEquals(beforeScope.achievements, afterScope.achievements)
        ...
        fun `setScope should not trigger additional repository calls`() = runTest {
            ...
            viewModel.uiState.test {
                ...
                // The only calls should be the initial ones from setup
                cancelAndIgnoreRemainingEvents()
            }
        }
    }
