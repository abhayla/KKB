...
- [ ] **#34 sweep extension to remaining 4 files** (optional) — broad `catch (e: Exception)` instances remain across AuthRepositoryImpl, GroceryRepositoryImpl, PantryRepositoryImpl, StatsRepositoryImpl. Same TDD pattern (RED test → narrow to typed catch → GREEN).
