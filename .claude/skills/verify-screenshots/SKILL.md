...
description: >
  ...
  Read for content analysis, compares against baselines, performs ADB structural checks
  (uiautomator dump), verifies backend state via API calls, manages baseline storage,
