...
- [ ] **#34 sweep extension to remaining 5 files** (optional) — broad `catch (e: Exception)` instances remain across AuthRepositoryImpl, GroceryRepositoryImpl, SettingsRepositoryImpl, PantryRepositoryImpl, StatsRepositoryImpl. Same TDD pattern (RED test → narrow to typed catch → GREEN).
