...
class ChatViewModelTest {
    ...
    inner class InitialState {
        ...
        fun `initial state should be loading`() = runTest {
            val viewModel = ChatViewModel(savedStateHandle, mockChatRepository, mockMealPlanRepository)
    ...
    inner class ScopeToggleTests {
        ...
        fun `setScope should not affect other state fields`() = runTest {
            ...
            viewModel.uiState.test {
                ...
                assertEquals(beforeScope.messages, afterScope.messages)
                assertEquals(beforeScope.quickActions, afterScope.quickActions)
