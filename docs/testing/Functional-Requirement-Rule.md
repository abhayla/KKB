...
| FR-006 | Recipe Rules Backend Sync (Offline-First) | [#45](https://github.com/abhayla/KKB/issues/45) | `RecipeRulesSyncFlowTest.kt` | `test_recipe_rules_api.py`, `test_migrate_legacy_rules.py` | 🚧 |
