...
class MigrationTest_10_11 {
     ...
     */
    @Ignore(
        "Pre-existing failure: meal_plan_items uses `order` (a SQL reserved keyword) " +
        "as a column name. API 29 emulator's SQLite rejects the unquoted INSERT " +
        "generated by Room. Fix requires a schema migration to rename the column " +
        "(follow-up PR)."
    )
    @Test
