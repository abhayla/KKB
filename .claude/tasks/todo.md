...
- [ ] **#34 sweep extension to remaining 3 files** (optional) — broad `catch (e: Exception)` instances remain across AuthRepositoryImpl (4), PantryRepositoryImpl (7), StatsRepositoryImpl (8). Same TDD pattern (RED test → narrow to typed catch → GREEN).
